...
![Curseforge][shield:curseforge] ![GitHub][shield:github] ![SpaceDock][shield:spacedock] ![CKAN][shield:ckan]  
...
### Supports
- [x]  [Kerbal Change Log][thread:kcl]  
- [x]  [Firespitter][thread:fs] [optional] for fully functioning wheels and retracting wheels. may cause bouts of dizziness.
### Conflicts
- none known
***
